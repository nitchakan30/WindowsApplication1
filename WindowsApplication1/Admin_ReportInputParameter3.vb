...
Public Class Admin_ReportInputParameter3
    ...
    Private Sub Admin_ReportInputParameter3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_ok.Click
        ...
        Dim time_st As String = DateTimePicker1.Value.ToString("HH:mm:ss")
        Dim time_ed As String = DateTimePicker2.Value.ToString("HH:mm:ss")
        ...
        cryRpt.SetParameterValue("time_s", time_st)
        cryRpt.SetParameterValue("time_e", time_ed)
